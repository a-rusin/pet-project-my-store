...
const formConfig = [
  { id: 0, label: "E-mail", name: "email", value: "", placeholder: "ivan.ivanov@mail.ru", type: "input-text", isRequired: true },
  { id: 1, label: "Пароль", name: "password", value: "", placeholder: "12345678", type: "input-text", isRequired: true },
  { id: 2, label: "Повторите пароль:", name: "confirmPassword", value: "", placeholder: "12345678", type: "input-text", isRequired: true },
  { id: 3, label: "Имя", name: "name", value: "", placeholder: "12345678", type: "input-text", isRequired: true },
  { id: 4, label: "Телефон", name: "phone", value: "", placeholder: "+8 (913) 888 88 88", type: "input-text", isRequired: true },
];
